...
export function AboutDialog({ isOpen, onClose }: DialogProps) {
  ...
  return (
    <Dialog
      open={isOpen}
      onClose={onClose}
      title="About DC TuneR Rojo Studio"
      size="sm"
    >
      <Dialog.Body className="dialog-about">
        <div className="dialog-about-logo">
          <img src="/logo.png" alt="DC TuneR Rojo Studio" style={{ width: 64, height: 64, borderRadius: '50%' }} />
        </div>
        <h3>DC TuneR Rojo Studio</h3>
