  ...
  const steps: OnboardingStep[] = [
    {
      ...
      icon: Car,
      details: [
        'DC TuneR Rojo Studio is an open-source ECU tuning platform supporting Speeduino, rusEFI, FOME, epicEFI, and MegaSquirt.',
    ...
    },
    {
      ...
      description: 'Learn more about DC TuneR Rojo Studio',
      icon: BookOpen,
      details: [
