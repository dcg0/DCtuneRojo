...
export default function QuickStartGuide({ isOpen, onClose }: QuickStartGuideProps) {
  ...
  const steps: QuickStartStep[] = [
    {
      id: 'welcome',
      title: 'Welcome to DC TuneR Rojo Studio',
      ...
      instructions: [
        ...
        'Each step includes tips and explanations to help you understand DC TuneR Rojo Studio.',
      ],
    },
    {
      id: 'create-project',
    ...
    },
    {
      ...
      instructions: [
        ...
        '   • DC TuneR Rojo Studio automatically detects and parses the format',
    ...
    },
    {
      ...
      instructions: [
        ...
        '6. DC TuneR Rojo Studio will automatically sync with your ECU',
      ],
      tips: [
